...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    List<Appointment> findAppointmentByAppointmentDateTime(String appointmentDateTime);
    boolean existsByDoctorId(Long doctorId);
    boolean existsByPatientId(Long patientId);
    boolean existsByStatus(AppointmentStatus status);
    boolean existsByAppointmentDateTime(String appointmentDateTime);

    List<Appointment> findByDoctorIdAndStatus(Long doctorId, AppointmentStatus status);
    List<Appointment> findByPatientIdAndStatus(Long patientId, AppointmentStatus status);

    List<Appointment> findByDateTimeBetween(LocalDate startTime, LocalDate endTime);
}
